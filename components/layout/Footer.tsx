        ...
        <div className="grid gap-8 lg:grid-cols-4">
          ...
          <nav aria-label="Servicios">
            ...
            <ul className="space-y-2 text-sm" role="list">
              ...
              <li>
                <Link href="/servicios#consignacion" className="hover:text-primary-400 transition-colors">
                  Consignación
                </Link>
              </li>
              <li>
                <Link href="/servicios#parte-de-pago" className="hover:text-primary-400 transition-colors">
                  Parte de Pago
                </Link>
              </li>
            </ul>
